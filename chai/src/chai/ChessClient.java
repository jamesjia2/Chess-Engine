...
public class ChessClient extends Application {
	...
	public void start(Stage primaryStage) {
		...
		moveMaker[Chess.BLACK] = new AIMoveMaker(new MiniMax(1,4));
		//moveMaker[Chess.BLACK] = new AIMoveMaker(new AlphaBeta(1,4));
		//moveMaker[Chess.BLACK] = new AIMoveMaker(new AlphaBetaTransposition(1,4));
